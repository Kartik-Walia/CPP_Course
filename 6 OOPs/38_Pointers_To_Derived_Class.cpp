...
int main(){
    ...
    base_class_pointer->var_base=34;base_class_pointer->display();
    ...
    base_class_pointer->var_base=3400;base_class_pointer->display();
...
// We can tell befor eby just looking taht to which display function it would bind 
