...
// To return the object for which this memeber function is running
...
class A {
    ...
    public:
    // void setData(int a){
    //     a=a;     // Local variable is accessed instead of class variable due to it's high priority
    // }
    // Above gives garbage value 
    
    // "this" pointer is used in case you want to keep argument name and class variable name same 
    A & setData(int a) {    // object is passed as reference & it's return type is A 
        this->a =a;
