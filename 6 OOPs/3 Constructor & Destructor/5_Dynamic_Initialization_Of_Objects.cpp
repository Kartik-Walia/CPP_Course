...
// Only at runtime we're gonna know that which constructor is invoked (on basis of user input)
...
public:
    BankDeposit() {}                    // Needed this bcoz when nothing is passed a constructor must be run
...
// NOTE:
// If you make multiple constructors, then it's compulsary to make one Default Constructor
